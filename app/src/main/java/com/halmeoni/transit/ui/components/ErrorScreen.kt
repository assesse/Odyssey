...
fun ErrorScreen(
    ...
    Column(
        ...
        BigButton(text = "다시 시도", onClick = onRetry, backgroundColor = MaterialTheme.colorScheme.primary)
        Spacer(modifier = Modifier.height(20.dp))
        BigButton(text = "처음으로", onClick = onGoHome, backgroundColor = HomeButtonGreen)
    }
}
